...
def get_upper_section_diff(scoreboard):
    ...
    Therefore, this method can be used to get a number for how the upper section is going.
    """
    # NOTE: EV Future improvements:
